    ...
    <a-spin :spinning="spinning">
      <a-form class="ant-advanced-search-form" :form="form">
        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="耗时(毫秒)" :label-col="labelCol" :wrapper-col="wrapperCol">
              <a-input disabled v-decorator="['elapsedTime']" />
            </a-form-item>
          </a-col>
        </a-row>
...
<script>
import { getApiLog } from '@/api/apiLog'
export default {
  props: {
    modifyEntity: {
      type: Object,
    ...
    loadData() {
      ...
      this.$nextTick(() => {
        ...
        if (this.modifyEntity.operation !== this.operationFlag.Add) {
          ...
          let that= this
          getApiLog({ id: this.modifyEntity.id }).then((res) => {
