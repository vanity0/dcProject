<template>
  <a-spin :spinning="spinning">
    <a-card :bordered="true">
      <a-tabs default-active-key="1" v-model="activeKey" @change="handleTabChange">
        <a-tab-pane key="1">
          <span slot="tab">基础信息</span>
          <a-card title="基础信息">
            <a-form :form="form">
              <!--产品名称,产品类型-->
              <a-row :gutter="10">
                ...
                <a-col :span="12">
                  <a-form-item label="产品分类" :label-col="labelCol" :wrapper-col="wrapperCol">
                    <a-select
                      ...
                      style="width: 100%"
                    >
                      <a-select-option v-for="item in productTypes" :key="item" :value="item">{{
                        item
                      }}</a-select-option>
                    </a-select>
                  </a-form-item>
                ...
                <a-col :span="12">
                  <a-form-item label="上架推手" :label-col="labelCol" :wrapperCol="wrapperCol">
                    <a-select
                      ...
                      style="width: 100%"
                    >
                      <a-select-option v-for="item in auditStatus" :key="item" :value="item">{{
                        item
                      }}</a-select-option>
                    </a-select>
                  </a-form-item>
          ...
          <a-card v-if="readOnly" class="element-top" title="操作历史">
            <a-form>
              <a-row>
                <a-col :span="12">
        ...
        <a-tab-pane key="2" v-if="!showFooterToolBar">
          <span slot="tab">PV访问信息</span>
        </a-tab-pane>

        <a-tab-pane key="3" v-if="!showFooterToolBar">
          <span slot="tab">UV点击信息</span>
        </a-tab-pane>

        <a-tab-pane key="4" v-if="!showFooterToolBar">
          <span slot="tab">CPA注册信息</span>
        </a-tab-pane>
      </a-tabs>
      <footer-tool-bar v-if="showFooterToolBar">
...
export default {
  ...
  methods: {
    //点击tab标签
    handleTabChange(key) {
      this.showFooterToolBar = key === '1' ? true : false
    },
