    ...
    public static class RSAEncryptHelper
    {
        ...
        public static void GetRSAKey(out string xmlKeys, out string xmlPublicKey)
        {
            try
            {
                ...
                //RSACryptoServiceProvider rsa2 = new RSACryptoServiceProvider(1024, csp);

                //RSAParameters privateKey = rsa2.ExportParameters(true);
                //RSAParameters publicKey = rsa2.ExportParameters(false);
